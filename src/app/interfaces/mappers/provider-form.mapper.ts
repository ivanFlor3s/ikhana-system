...
export function mapProviderFormToDto(formData: ProviderFormData): CreateProviderDto {
    ...
    return {
        ...
        business_hours_start: formData.since ? formatTime(formData.since.hours, formData.since.minutes) : undefined,
        business_hours_end: formData.to ? formatTime(formData.to.hours, formData.to.minutes) : undefined,
        // Broker data
