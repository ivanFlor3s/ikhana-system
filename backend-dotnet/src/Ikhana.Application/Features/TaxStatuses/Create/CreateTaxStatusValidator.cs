...
public class CreateTaxStatusValidator : AbstractValidator<CreateTaxStatusCommand>
{
    private readonly IAppDbContext _context;

    public CreateTaxStatusValidator(IAppDbContext context)
    {
        _context = context;
    ...
    private async Task<bool> BeUniqueCode(string code, CancellationToken cancellationToken)
    {
        return !await _context.TaxStatuses
            .AnyAsync(t => t.Code == code && t.DeletedAt == null, cancellationToken);
    }
}
